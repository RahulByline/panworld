...
-- MySQL schema (Prisma-free)
-- Engine: InnoDB, Charset: utf8mb4

SET NAMES utf8mb4;
SET time_zone = '+00:00';

-- Disable FK checks for clean imports
...
CREATE TABLE products (
  ...
  type VARCHAR(32) NOT NULL, -- TEXTBOOK | LIBRARY | KIT | UNIFORM | RESOURCE
  grade_min INT NULL,
  grade_max INT NULL,
...
CREATE TABLE contacts (
  ...
  type VARCHAR(64) NOT NULL, -- ACCOUNT_MANAGER | REGIONAL_MANAGER | PUBLISHER_REP
  created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Integration logs (Odoo readiness)
